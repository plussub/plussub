...
(function (r, t) {
            ...
            if (this.settings.diacritics) {
                for (u in f) {
                    if (f.hasOwnProperty(u)) {
                        o = o.replace(new RegExp(u, "g"), f[u])
                    }
                }
            }
            s.push({string: a[t], regex: new RegExp(o, "i")})
        }
        return s
    };
    ...
    r.prototype.getSortFunction = function (r, e) {
        var n, i, o, f, u, s, a, c, p, l, h;
        o = this;
        r = o.prepareSearch(r, e);
        h = !r.query && e.sort_empty || e.sort;
        p = function (r, t) {
            if (r === "$score")return t.score;
            return o.items[t.id][r]
        };
        u = [];
        if (h) {
        ...
        if (r.query) {
            ...
            if (l) {
                u.unshift({field: "$score", direction: "desc"})
            }
        } else {
            for (n = 0, i = u.length; n < i; n++) {
                if (u[n].field === "$score") {
    ...
    var u = function () {
        ...
        for (e in f) {
            if (f.hasOwnProperty(e)) {
                n = f[e].substring(2, f[e].length - 1);
                i += n;

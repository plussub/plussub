...
export type AllEvents = VideoInIFrameEvent | RemoveMessageEventListenerEvent | StartTranscriptEvent | StopTranscriptEvent | RemoveSubtitleEvent | AddSubtitleEvent | VideoCurrentTimeEvent | SetVideoTimeEvent;

<template>
  <div class="search-container">
    ...
    <div class="knopf-group" style="grid-area: search-bar; display: flex;">
      ...
      <a class="knopf flat pill small sharp" style="color: white; width: 40px;"><i class="fa fa-search fa-sm"></i></a>
    </div>
    ...
    <div class="knopf-group" style="grid-area: sub-lang-drop-down; display: flex;">
      ...
      <a class="knopf even active pale sharp" style="color: white; width: 40px;"><i class="fa fa-chevron-down fa-sm"></i></a>
    </div>
  </div>
</template>
  ...
  setup() {
    ...
    watch(
      ...
      async function (result) {
        emit('searchResult', result?.data?.videoSearch?.entries ?? []);
      }
    );

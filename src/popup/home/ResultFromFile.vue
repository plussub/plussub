<template>
  <div class="result-from-file--card" style="position: relative;">
    ...
    <div style="grid-area: card-header; font-family: var(--card-header-font-family); font-size: var(--card-header-font-size); color: var(--default-header-text-color); display: flex;">

...
.knopf.knopf:disabled, .knopf.disabled {
  cursor: default;
  opacity: 40%;
  pointer-events: none
}
...
.knopf.knopf:hover, .knopf.knopf:active {
...
.knopf.knopf:focus, .knopf.knopf:focus-within {
  --knopf-box-shadow: 0 0 0 .15em hsl(var(--knopf-color) / 40%);
  outline: 0
}
